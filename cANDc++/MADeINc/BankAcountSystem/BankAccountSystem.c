// get from https://www.geeksforgeeks.org/bank-account-system-in-c-using-file-handling/
...
int main()
{
    ...
    printf("CREATOR OF ORIGINAL CODE : Naman kumar");
...
void transfermoney(void)
{
    ...
    gotoxy(33, 40);
    printf("AMOUNT SUCCESSfULY TRANSFERRED....");
    getch();
